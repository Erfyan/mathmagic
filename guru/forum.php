...
if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['new_thread'])) {
    ...
    $role = 'guru';
    $stmt->bind_param("ssis", $title, $content, $teacher_id, $role);
    $stmt->execute();
    $stmt->close();
...
<head>
<meta charset="UTF-8">
<title>Forum Guru - MATHMAGIC</title>
<style>
/* sama seperti siswa/forum.php */
body {margin:0; background: linear-gradient(135deg,#667eea,#764ba2,#f093fb); color:#333; min-height:100vh;}
